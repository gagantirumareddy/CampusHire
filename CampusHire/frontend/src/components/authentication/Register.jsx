...
const Register = () => {
  ...
  return (
    <section className="flex flex-col relative h-screen w-full bg-[#2A2A2A]" >
              ...
              <div className="relative w-full">
                <div className="mx-0 flex flex-col">
                    <div className="flex my-40 mx-auto lg:flex-row justify-around">
                        ...
                        <svg 
                        className="flex mx-auto "
                        fill="#2A2A2A" width="100px" height="100px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
